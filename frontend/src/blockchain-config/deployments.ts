    ...
    8453: {
        ...
        "0x0ac9591c190692fdcfa1baf00c4d89ee1b5050d6": {
            ...
            "metadata": {
                ...
                "getMarketStateContext": "The two functions that should be used to get the current state of a market are getMarket(address marketId) external view for all of the market's current state, and getUserBalances(address marketId, address user) external view to get the user's outcome token share balances. Prices returned are always in 6-decimal USDC units.",
                ...
                "priceHistoryOrChartContext": "To show the price history of an outcome token, use the useQueryEvents hook to query the OutcomeTraded event and it's history. Each emission of this event has the price of a given outcome token at that point in time. Prices are always in 6-decimal USDC units.",
        ...
        "0xc909a4e17e5d7f19eb9e91ae30d21a77c7f06074": {
            "abi": CONTRACT_ABIS["0x18bea6f6c42a4e7e554591ea7c0da3be358171f171157fc26776b2e2303d7bc4"],
            "sourceCodeMetadata": CONTRACT_SOURCE_METADATAS["0x18bea6f6c42a4e7e554591ea7c0da3be358171f171157fc26776b2e2303d7bc4"],
            "type": "imported",
            "chainId": 8453,
            "address": "0xc909a4e17e5d7f19eb9e91ae30d21a77c7f06074",
            "implBytecodeHash": "0x18bea6f6c42a4e7e554591ea7c0da3be358171f171157fc26776b2e2303d7bc4",
            "contractName": "ERC721SeaDropCloneable",
            "metadata": {},
            "originalVerifiedSource": "Sourcify",
            "selected": true
        }
